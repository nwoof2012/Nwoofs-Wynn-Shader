    ...
    void main() {
        ...
        #if DEBUG == 1 && DEBUG_MODE == 11
            outcolor = vec4(shadowLerp);
            return;
        #endif
        ...
        float sideFacing = 1.0 - abs(Normal.y);

        vec3 ambientUp   = vec3(0.36, 0.48, 0.70);
        vec3 ambientSide = vec3(0.20, 0.25, 0.33);
        vec3 ambientDown = vec3(0.08, 0.075, 0.065);
